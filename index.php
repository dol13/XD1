    ...
    <div class="container mt-5">
        <center>
            <table style="width:90%" border="1">
                <tr>
                    <td>
                        <form class="row g-3 needs-validation" novalidate id="myForm" action="444.php" method="POST">
                            <h4>ข้อมูลผู้ส่ง</h4>
                            <div class="col-md-4">
...
<option value="ลำต้อยติ่ง">ลำต้อยติ่ง</option>
                            ...
                            <div class="col-12">
                                <a href="444.html"><button class="btn btn-primary" type="submit">Submit form</button></a>
                            </div>
                        </form>
                    </td>
                </tr>
